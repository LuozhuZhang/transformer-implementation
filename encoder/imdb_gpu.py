...
class TransformerEncoder(nn.Module):
    def __init__(self, num_layers, d_model, num_heads, d_ff, vocab_size):
        ...
        self.positional_encoding = PositionalEncoding(d_model)  #! Here we are using positional encoding
        self.layers = nn.ModuleList([TransformerEncoderLayer(d_model, num_heads, d_ff) for _ in range(num_layers)])  #! Here we are using multiple encoder layers
